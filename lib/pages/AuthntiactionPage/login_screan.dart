        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              CustomTextField(hintText: "Your Email", prefixIcon: Icons.person),
              ...
              customtextbottom(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => HomePlaseHolder()),
                  );
                },
              ),
      ...
      children: [
        ...
        GestureDetector(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => RegisterScean()),
            );
          },
          child: Text(
            "Sign Up",
