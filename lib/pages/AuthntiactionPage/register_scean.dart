...
import 'package:studing/pages/anotherSceans/home_plase_holder.dart';
...
class RegisterScean extends StatelessWidget {
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                SvgPicture.asset("assets/icons/signup.svg", height: 200.h),
                SizedBox(height: 20.h),
                ...
                customtextbottom(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => HomePlaseHolder(),
                      ),
                    );
                  },
                ),
  ...
  GestureDetector signInTaped(BuildContext context) {
    return GestureDetector(
      ...
      child: Text(
        "Sign In",
        style: TextStyle(color: Color(0xFF6F35A5), fontWeight: FontWeight.bold),
      ),
    );
  }

  Padding orAndDivider() {
    return Padding(
